...
% Satellite effective isotropic
% radiated power (EIRP) 34 [dBW/MHz]
...
UL_model(EIRP_density, G_T, SAT_altitude)
DL_model(EIRP_density, G_T, SAT_altitude)
